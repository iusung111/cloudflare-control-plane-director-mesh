...
- **Working Docs:** Must follow the "one responsibility" rule and include "Purpose" and "What this file does not cover" sections.
- **ADRs (Architecture Decision Records):** Must be immutable, follow the ADR template (Status, Context, Decision, Consequences), and be superseded rather than edited.
...
- If you need the reason for a key decision, open `docs/adr/`.

- No working doc should be big. One file = one responsibility.
- Every working doc must say what it is for, what it updates, what it references, and what it must NOT contain.
## Purpose
